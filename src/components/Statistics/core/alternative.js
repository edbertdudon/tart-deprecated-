...
const Alternative = ({ authUser, color, setAlt, alt }) => {
	...
	return (
	    ...
	    <Button onClick={handleAlt0} condition={alt === 0} text={ALTERNATIVES[0]} color={color[authUser.uid]} />
	    <Button onClick={handleAlt1} condition={alt === 1} text={ALTERNATIVES[1]} color={color[authUser.uid]} />
			<Button onClick={handleAlt2} condition={alt === 2} text={ALTERNATIVES[2]} color={color[authUser.uid]} />
		</>
	)
}
