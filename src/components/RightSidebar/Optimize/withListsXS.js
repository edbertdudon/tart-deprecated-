...
const withListsXS = Component => (props) => {
	...
	return (
		<div ref={wrapperRef} className='rightsidebar-dropdown-xs-wrapper'>
			<div className='rightsidebar-dropdown-xs' onClick={toggleComponent} style={props.styles}>
				{props.name}
			</div>
			{(showOptions && props.options.length > 0) &&
				<div className='rightsidebar-dropdown-content-xs'>
