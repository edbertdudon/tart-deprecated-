const statistics = [
	...
	// {key: "Exact binom test", function: "binom.test()", category: 0},
	// {key: "Box-pierce and Ljung-Box test", function: "Box.test()", category: 0},
	...
	// {key: "Kolmogorov-Smirnov test", function: "ks.test()", category: 0},
	// {key: "Mauchly's test of sphericity", function: "mauchly.test()", category: 0},
	// {key: "Mcnemar's Chi-Squared test for count data", function: "mcnemar.test()", category: 0},
	...
	// {key: "Pairwise comparisons for proportions", function: "bartlett.test()", category: 0},
	{key: "Pairwise t-tests", function: "pairwise.t.test()", category: 8},
	// {key: "Pairwise Wilcoxon rank sum tests", function: "pairwise.wilcox.test()", category: 0},
	// {key: "Exact poisson test", function: "poisson.test()", category: 0},
	// {key: "Power calculations for balanced one-way analysis of variance tests", function: "power.anova.test()", category: 0},
	// {key: "Power calculations for one and two sample t-tests", function: "power.t.test()", category: 0},
	// {key: "Phillips-Perron test for unit roots", function: "PP.test()", category: 0},
	// {key: "Print method for hypothesis tests and power calculation object", function: "print.htest()", category: 0},
	// {key: "Test for equal or given proportions", function: "prop.test()", category: 0},
	{key: "Quade test", function: "quade.test()", category: 8},
	// {key: "Shapiro-Wilk normality test", function: "shapiro.test()", category: 0},
