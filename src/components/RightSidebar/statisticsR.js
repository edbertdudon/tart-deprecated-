const statistics = [
	...
	{
		key: "Paired t-test",
		function: "t.test(paired=TRUE,",
		arguments: ["xvariable", "yvariable", "alt", "varEqual", "conf"],
		category: 2
	},
	{
		key: "Independent Two-group t-test",
		function: "t.test(",
		arguments: ["xvariable", "yvariable", "alt", "varEqual", "conf"],
		category: 2
	},
	...
	{
		key: "Independent Two-group Mann-Whitney U Test",
		function: "wilcox.test(",
		arguments: ["xvariable", "yvariable", "alt"],
		category: 4
	},
	{
		key: "Dependent Two-group Wilcoxon Signed Rank Test",
		function: "wilcox.test(paired=TRUE,",
		arguments: ["xvariable", "yvariable", "alt"] ,
		category: 4
	},
	{
		key: "Kruskal-Wallis rank sum test",
		function: "kruskal.test(",
		arguments: ["xvariable", "groups"],
		category: 4
	},
	{
		key: "Friedman rank sum test",
	...
	},
	{
		...
		function: "confint(",
		arguments: ["multipleLinearRegression", "conf"],
		category: 5
	},
	{
		key: "Fitted Values",
	...
	{
		key: "Variance-covariance matrix",
		function: "vcov(",
		arguments: ["multipleLinearRegression"],
		category: 5
	},
	{
		key: "Linear model fitting",
		function: "influence(",
		arguments: ["multipleLinearRegression"],
		category: 5
	},
	{
		key: "Compare models (ANOVA)",
		function: "anova(",
	...
	{
		key: "Randomized block design ANOVA",
		function: "aov(",
	...
	{
		key: "Analysis of covariance (ANCOVA)",
		function: "aov(",
		arguments: ["analysisOfCovariance"],
		category: 6
	},
	{
		key: "One-Way within subjects ANOVA",
		function: "aov(", arguments: ["oneWayWithin"],
		category: 6
	},
	{
		key: "Two-Way within subjects ANOVA",
		function: "aov(",
		arguments: ["twoWayWithin"],
		category: 6
	},
	{
		key: "Two-Way between factors ANOVA",
		function: "aov(",
	...
	{
		key: "Randomized block design MANOVA",
		function: "manova(",
	...
	{
		key: "Analysis of covariance (MANCOVA)",
		function: "manova(",
		arguments: ["mancova"],
		category: 7
	},
	{
		key: "One-Way within subjects MANOVA",
		function: "manova(",
		arguments: ["oneWayWithinManova"],
		category: 7
	},
	{
		key: "Two-Way within subjects MANOVA",
		function: "manova(",
		arguments: ["twoWayWithinManova"],
		category: 7
	},
	{
		key: "Two-Way between factors MANOVA",
		function: "manova(",
